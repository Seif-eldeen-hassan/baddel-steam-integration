...
# Baddel: replaced galaxy.api.types with simple local classes
import enum as _enum

class LocalGameState(_enum.IntFlag):
    None_     = 0
    Installed = 1
    Running   = 2

class LocalGame:
    def __init__(self, game_id, local_game_state):
        self.game_id          = game_id
        self.local_game_state = local_game_state
