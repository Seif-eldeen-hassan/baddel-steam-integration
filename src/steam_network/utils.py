...
# Baddel: replaced galaxy.api.errors with simple exception classes
class AccessDenied(Exception): pass
class BackendError(Exception): pass
class BackendNotAvailable(Exception): pass
class BackendTimeout(Exception): pass
class Banned(Exception): pass
class InvalidCredentials(Exception): pass
class NetworkError(Exception): pass
class TemporaryBlocked(Exception): pass
class AuthenticationRequired(Exception): pass
class UnknownError(Exception): pass
class NextStep:
    def __init__(self, auth_params, step_info):
